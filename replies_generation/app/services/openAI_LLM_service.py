...
from openai import OpenAI  # Import the OpenAI client class for API accessimport  replies_generation.characters.prompts_creation as prompts_creation  # Import the prompts dictionary containing pre-defined text prompts
import json  
import os
...
def generate_reply_openAI(user_prompt, system_prompt): 
