...
good_traits = {
    ...
    "S3": ["Creative thinker","Detail-oriented", "Courageous"],
...
bad_traits = {
    ...
    "S3" : ["Overthinks","Self-doubt in male-dominated settings","Sensitive to criticism"],
...
internal_conflicts = {
    ...
    "S3" : ["I must prove that I belong here."],
